...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3f028597-c098-47ee-b650-5e8783036cb0
```

> `3f028597-c098-47ee-b650-5e8783036cb0` is the password of the certificate, you can change it to any password you want.
